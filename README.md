...
Проект разработан как демонстрация навыков **Full-stack Java** разработки и отлично подходит для портфолио.
...
ФункцияСтатусРегистрация / Логин✅ ГотовоДобавление треков✅ ГотовоКаталог треков✅ ГотовоИзбранное✅ ГотовоАдмин-панель✅ ГотовоЗагрузка обложек✅ ГотовоПоиск по трекам🔄 В планах
